...
int main(void)
{
    ...
    LcdWriteString("Name list of beverage: ");
    HAL_DelayUSec(1000*1000);
    LcdClear();
    LcdWriteString("1. Pepsi     $1.00");
    HAL_DelayUSec(1000*1000);
    LcdClear();                          
    LcdWriteString("2. Miranda   $2.00"); 
    HAL_DelayUSec(1000*1000);
    LcdClear();                       
    LcdWriteString("3. Mountain Dew  $3.00"); 
    HAL_DelayUSec(1000*1000);
    LcdClear();                  
    ...
    if(x)
     {
              ...
              LcdWriteString("Enter your money: $5   $10   &15  ");
              HAL_DelayUSec(1000*1000);
              LcdClear(); 
              if(x)
             {  LcdWriteString("Please collect your product and money : 4");
             HAL_DelayUSec(1000*1000);
              LcdClear();
              ...
              elseif(y)
              {
                LcdWriteString("Please collect your product and money : 9");
                HAL_DelayUSec(1000*1000);
              LcdClear();
              ...
              {
                LcdWriteString("Please collect your product and money : 14");
                HAL_DelayUSec(1000*1000);
              LcdClear();
    ...
    elseif(y)
    {
        LcdWriteString("You choose Miranda");
        HAL_DelayUSec(1000*1000);
              LcdClear();                  
              ...
              LcdClear();
              if(x)
             {  LcdWriteString("Please collect your product and money : 3");
                HAL_DelayUSec(1000*1000);
              LcdClear();
               } 
              elseif(y)
              {
                LcdWriteString("Please collect your product and money : 8");
               HAL_DelayUSec(1000*1000);
              LcdClear();  
              }
              else
              {
                LcdWriteString("Please collect your product and money : 13");
               HAL_DelayUSec(1000*1000);
              LcdClear();    
              }
    }
    ...
    {
       LcdWriteString("You choose Mountain Dew");                  
            HAL_DelayUSec(1000*1000);
              LcdClear();
              LcdWriteString("Enter your money: $5   $10   &15  ");
              HAL_DelayUSec(1000*1000);
              LcdClear();
              if(x)
             {  LcdWriteString("Please collect your product and money : 2");
             HAL_DelayUSec(1000*1000);
              LcdClear();
              ...
              elseif(y)
              {
                LcdWriteString("Please collect your product and money : 7");
                HAL_DelayUSec(1000*1000);
              LcdClear();
              ...
              {
                LcdWriteString("Please collect your product and money : 12");
                HAL_DelayUSec(1000*1000);
              LcdClear();
